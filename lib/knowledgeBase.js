...
// know and talk about. Written in third person since the assistant speaks
// ABOUT Muhammad, not as him.
//
// knowledgeBase     → full narrative version (for reference / future use)
// knowledgeBaseCompact → token-efficient version injected into every API call
...
// Compact version used by the API route — same facts, ~60% fewer tokens
// to avoid hitting Groq's request size limits.
export const knowledgeBaseCompact = `
ABOUT: Muhammad Adeel, AI undergraduate, Air University, Sep 2023–present, CGPA 2.96/4.00. Builds end-to-end ML/AI systems: healthcare AI, computer vision, NLP, RAG, full-stack apps.

CONTACT: Email: adeel444alvi@gmail.com | Phone: +92 336 2447035 | GitHub: github.com/adeelalvi07 | LinkedIn: linkedin.com/in/muhammadadeelroshaan | Location: Rawalpindi, Pakistan | Open to: internships, freelance AI work, full-time ML/AI roles.

EDUCATION: BS Artificial Intelligence, Air University, 2023–present, CGPA 2.96/4.00. Coursework: ML, Deep Learning, Computer Vision, NLP, Information Retrieval, DSA, Full-Stack Web Dev, Database Systems.

EXPERIENCE: Technical Intern at Software Productivity Strategists, Inc. (SPS), Remote, Jul–Sep 2025. 10-week structured internship across multiple software engineering tracks. Remote collaboration, fast technical learning, practical deliverables.

SKILLS:
- Languages: Python, JavaScript, C++, SQL, Assembly
- AI/ML: Machine Learning, Deep Learning, Computer Vision, NLP, RAG, XAI, Transfer Learning, Multimodal AI
- Frameworks: TensorFlow/Keras, Scikit-learn, OpenCV, LangChain, FAISS, Streamlit, FastAPI, Next.js, React, Node.js
- Databases: MySQL, MongoDB, SQLite
- Tools: Git, GitHub, Postman, Google Colab, VS Code, Figma
- Exploring: PostgreSQL, Voice AI, AI SaaS, agentic workflows

PROJECTS:
1. MediAssist: Healthcare AI platform — ML disease prediction (Scikit-learn), NLP/RAG medical chatbot, hospital locator (NetworkX graph search).
2. ANPR: Real-time license plate detection at 15–25 FPS using OpenCV + OCR, Streamlit analytics dashboard.
3. Auto Complete NLP: N-Gram language model from scratch — tokenization, OOV handling, Laplace smoothing.
4. Chess via Socket Programming: Two-player LAN chess with client-server sync.
5. Heart Disease Prediction: Random Forest model + FastAPI backend + React frontend + JWT auth + MongoDB.
6. DeepCure: Unified multi-disease prediction platform (7 diseases, multiple models, single interface).
7. AI Portfolio Website: Next.js 14, Tailwind CSS, Framer Motion, integrated AI chatbot (this site).
8. US Plumbing Chatbot (client): Customer-facing AI chatbot, FastAPI + SQLite, appointment booking, business alerts.

CERTIFICATIONS:
- Supervised Machine Learning — DeepLearning.AI (Coursera), Jul 2025
- Generative AI: Intro & Application — IBM (Coursera), Jul 2025
- Generative AI: Prompt Engineering Basics — IBM (Coursera), Aug 2025
- Oracle Fusion AI Agent Studio Foundations Associate — Oracle, 2025
`.trim();
